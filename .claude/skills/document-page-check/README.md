...
- **`codebase-file-orientation`** — the other `Documents/` skill, and the exact
...
- **`ambiguity-gate`** — fires when a *request* is ambiguous. This fires on a
...
- **`ticket-evaluation`** — separates what a ticket says from what it's missing.
