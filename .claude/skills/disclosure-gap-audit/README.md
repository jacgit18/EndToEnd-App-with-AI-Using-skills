...
`change-surface-audit`, `failure-mode-analysis`, and
`document-page-check`. It doesn't withhold judgment pending a user rep. It does
...
```
cp -r ".claude/skills/disclosure-gap-audit" /path/to/other-repo/.claude/skills/
```
